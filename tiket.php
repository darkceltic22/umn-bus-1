    ...
    <div class="col-md col-sm mt-4 text-center spasi">
      ...
      <?php
        ...
        while ($row = $result1->fetch_assoc()) {
            echo '<a href="batal-tiket-satu.php?bis=' . $row["busID"] . '&seat=' . $row["noKursi"] . '" class="btn btn-danger" role="button" onclick="myFunction()" value="Show alert box">Batalkan Tiket</a>';}
            ?>
